...
export const BackAllow = ({ ...props }: IconProps): JSX.Element => {
  return (
    <svg {...props} width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 1L1 8L8 15" stroke="#F0F3F5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M1 8H17" stroke="#F0F3F5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}